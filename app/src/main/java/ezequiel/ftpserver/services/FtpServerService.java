...
import ezequiel.ftpserver.RequestFtplet;
import ezequiel.ftpserver.filesystem.FsFtpFileSystemView;
import ezequiel.ftpserver.filesystem.RoSafFtpFileSystemView;
import ezequiel.ftpserver.filesystem.RootFtpFileSystemView;
import ezequiel.ftpserver.filesystem.SafFtpFileSystemView;
...
public class FtpServerService extends AbstractServerService {
    ...
    protected boolean launchServer(final Shell.Interactive shell) {
        ...
        ftplets.put("1", new RequestFtplet());
